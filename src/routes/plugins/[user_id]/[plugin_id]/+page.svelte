<script lang="ts">
    ...
    $: overview = Res.fromSerial<PluginResp, ProblemDetails>(data.result)
        .match({
            ok: (a: PluginResp): PluginResp | null => {
                problem = null;
                return a;
            },
            err: (e) => {
        ...
        }) satisfies Promise<PluginResp | null>;

    let ov: PluginResp | null = null;

    let searchTerm = "";

    function update(over: PluginResp | null): string {
        ov = over;
        return "";
    }
...
<Page notFoundMessage="Plugin not found" empty={false} {problem} queue={ov == null ? 1: 0 }>
                    ...
                    <div>
                        <Card.Header>
                            <div class="flex items-center gap-3">
                                ...
                                <Badge variant="outline" class="text-purple-600 border-purple-600">Plugin</Badge>
                            </div>
                        </Card.Header>
                        <Card.Content>
                            <Card.Description>
                ...
                <Tabs.Content value="version">
                    <Card.Root class="shadow-xl dark:border-muted-foreground dark:bg-background">
                        <Card.Header>
                            ...
                            <Card.Description>
                                Current and past versions of the plugin.
                            </Card.Description>
                        </Card.Header>
                        <Card.Content class="space-y-2">
